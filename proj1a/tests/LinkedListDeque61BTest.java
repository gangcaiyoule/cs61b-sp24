...
//     Below, you'll write your own tests for LinkedListDeque61B.
    ...
    //chesk isEmpty()
    @Test
    public void checkisEmpty_false() {
        Deque61B<Integer> lld1 = new LinkedListDeque61B<>();
    ...
    //check get but is empty
    @Test
    public void getitembutempty() {
        Deque61B<Integer> lld1 = new LinkedListDeque61B<>();
    ...
    public void removeFirstAndLast() {
        ...
        assertThat(lld1.removeFirst()).isEqualTo(-2);   // [-1, 0, 1, 2]
        assertThat(lld1.get(0)).isEqualTo(-1);
        assertThat(lld1.removeLast()).isEqualTo(2);    // [-1, 0, 1]
        assertThat(lld1.get(3)).isEqualTo(null);
    }
}